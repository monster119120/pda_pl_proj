...
class ImageNetLightningModel(LightningModule):
    ...
    def train_dataloader(self):
        ...
        # train_dataset = datasets.ImageFolder(train_dir, trans)

        train_dataset = ImageNet_C(root=self.data_path, splits='train', transform=trans)
    ...
    def val_dataloader(self):
        ...
        # test_dataset = datasets.ImageFolder(val_dir, trans)
        test_dataset = ImageNet_C(root=self.data_path, splits='val', transform=trans)
        
        val_loader = torch.utils.data.DataLoader(
            test_dataset, batch_size=self.batch_size, shuffle=False, num_workers=self.workers,
        )
        return val_loader
...
def run_cli():
    ...
    parent_parser.add_argument("--data-path", default='../data/imagenet-c', metavar="DIR", type=str, help="path to dataset")
