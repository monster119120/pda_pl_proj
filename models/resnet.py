...
def resnet18_dynamic() -> ResNet:
    model = ResNet(BasicBlockDynamic, [2, 2, 2, 2])
    return model

def resnet50_dynamic():
    model = ResNet(BottleneckDynamic, [3, 4, 6, 3])
    return model

def resnet152_dynamic():
    model = ResNet(BottleneckDynamic, [3, 8, 36, 3])
    return model
