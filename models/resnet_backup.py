...
__all__ = ['resnet18_dynamic', 'resnet50_dynamic', 'resnet101_dynamic']
...
def resnet18_dynamic() -> ResNet:
    model = _resnet('resnet18_dynamic', BasicBlockDynamic, [2, 2, 2, 2])
    return model


def resnet50_dynamic() -> ResNet:
    model = _resnet('resnet50_dynamic', BottleneckDynamic, [3, 4, 6, 3])
    return model